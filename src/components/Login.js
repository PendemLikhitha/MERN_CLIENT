...
export default function Login(){
    ...
    return(
        <form className="max-w-lg mx-auto p-8 bg-white shadow-md rounded-lg m-10 border border-blue-200" >
        <div className="mb-4">
        <h1 className="font-bold text-2xl mb-6 text-center">Login</h1>
            ...
            <button  onSubmit={HandleSubmit} type="submit" className="bg-blue-500 text-white font-bold py-2 px-4 rounded-lg w-full hover:bg-blue-700 transition duration-200">Login</button>
